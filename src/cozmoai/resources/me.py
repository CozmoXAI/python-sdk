...
from ..types.me_list_organizations_response import MeListOrganizationsResponse
    ...
    def list_organizations(
        ...
        *,
        ...
        return self._get(
            ...
            cast_to=MeListOrganizationsResponse,
        )
...
class MeResourceWithRawResponse:
    def __init__(self, me: MeResource) -> None:
        ...
        self.list_organizations = to_raw_response_wrapper(
            me.list_organizations,
        )
...
class AsyncMeResourceWithRawResponse:
    def __init__(self, me: AsyncMeResource) -> None:
        ...
        self.list_organizations = async_to_raw_response_wrapper(
            me.list_organizations,
        )
...
class MeResourceWithStreamingResponse:
    def __init__(self, me: MeResource) -> None:
        ...
        self.list_organizations = to_streamed_response_wrapper(
            me.list_organizations,
        )
...
class AsyncMeResourceWithStreamingResponse:
    def __init__(self, me: AsyncMeResource) -> None:
        ...
        self.list_organizations = async_to_streamed_response_wrapper(
            me.list_organizations,
        )
