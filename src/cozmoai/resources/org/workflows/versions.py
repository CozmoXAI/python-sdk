...
from ....types.org.workflows import version_list_params
from ....types.org.workflows.version_list_response import VersionListResponse
from ....types.org.workflows.version_retrieve_response import VersionRetrieveResponse
...
class VersionsResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        return self._get(
            f"/org/{org_id}/workflows/{workflow_id}/versions/{version}",
    ...
    def list(
        ...
        *,
        ...
        if not workflow_id:
            raise ValueError(f"Expected a non-empty value for `workflow_id` but received {workflow_id!r}")
        return self._get(
            f"/org/{org_id}/workflows/{workflow_id}/versions",
            options=make_request_options(
