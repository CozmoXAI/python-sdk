...
class TestEvals:
    ...
    def test_method_create(self, client: Cozmoai) -> None:
        eval = client.org.agents.evals.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    def test_raw_response_create(self, client: Cozmoai) -> None:
        response = client.org.agents.evals.with_raw_response.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    def test_streaming_response_create(self, client: Cozmoai) -> None:
        with client.org.agents.evals.with_streaming_response.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    def test_path_params_create(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.agents.evals.with_raw_response.create(
                org_id="",
                agent_id="agent_id",
                category="category",
                prompt="prompt",
    ...
    def test_method_update(self, client: Cozmoai) -> None:
        eval = client.org.agents.evals.update(
            eval_id=0,
            org_id="org_id",
        )
        assert_matches_type(Eval, eval, path=["response"])
    ...
    def test_raw_response_update(self, client: Cozmoai) -> None:
        response = client.org.agents.evals.with_raw_response.update(
            eval_id=0,
            org_id="org_id",
        )
    ...
    def test_streaming_response_update(self, client: Cozmoai) -> None:
        with client.org.agents.evals.with_streaming_response.update(
            eval_id=0,
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.agents.evals.with_raw_response.update(
                eval_id=0,
                org_id="",
            )
    ...
    def test_method_list(self, client: Cozmoai) -> None:
        eval = client.org.agents.evals.list(
            org_id="org_id",
            agent_id="agentId",
        )
    ...
    def test_raw_response_list(self, client: Cozmoai) -> None:
        response = client.org.agents.evals.with_raw_response.list(
            org_id="org_id",
            agent_id="agentId",
        )
    ...
    def test_streaming_response_list(self, client: Cozmoai) -> None:
        with client.org.agents.evals.with_streaming_response.list(
            org_id="org_id",
            agent_id="agentId",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_list(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.agents.evals.with_raw_response.list(
                org_id="",
                agent_id="agentId",
            )
    ...
    def test_method_delete(self, client: Cozmoai) -> None:
        eval = client.org.agents.evals.delete(
            eval_id=0,
            org_id="org_id",
        )
        assert eval is None
    ...
    def test_raw_response_delete(self, client: Cozmoai) -> None:
        response = client.org.agents.evals.with_raw_response.delete(
            eval_id=0,
            org_id="org_id",
        )
    ...
    def test_streaming_response_delete(self, client: Cozmoai) -> None:
        with client.org.agents.evals.with_streaming_response.delete(
            eval_id=0,
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.agents.evals.with_raw_response.delete(
                eval_id=0,
                org_id="",
            )
...
class TestAsyncEvals:
    ...
    async def test_method_create(self, async_client: AsyncCozmoai) -> None:
        eval = await async_client.org.agents.evals.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    async def test_raw_response_create(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.agents.evals.with_raw_response.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    async def test_streaming_response_create(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.agents.evals.with_streaming_response.create(
            org_id="org_id",
            agent_id="agent_id",
            category="category",
            prompt="prompt",
    ...
    async def test_path_params_create(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.agents.evals.with_raw_response.create(
                org_id="",
                agent_id="agent_id",
                category="category",
                prompt="prompt",
    ...
    async def test_method_update(self, async_client: AsyncCozmoai) -> None:
        eval = await async_client.org.agents.evals.update(
            eval_id=0,
            org_id="org_id",
        )
        assert_matches_type(Eval, eval, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.agents.evals.with_raw_response.update(
            eval_id=0,
            org_id="org_id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.agents.evals.with_streaming_response.update(
            eval_id=0,
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.agents.evals.with_raw_response.update(
                eval_id=0,
                org_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCozmoai) -> None:
        eval = await async_client.org.agents.evals.list(
            org_id="org_id",
            agent_id="agentId",
        )
        assert_matches_type(EvalListResponse, eval, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.agents.evals.with_raw_response.list(
            org_id="org_id",
            agent_id="agentId",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.agents.evals.with_streaming_response.list(
            org_id="org_id",
            agent_id="agentId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_list(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.agents.evals.with_raw_response.list(
                org_id="",
                agent_id="agentId",
            )
    ...
    async def test_method_delete(self, async_client: AsyncCozmoai) -> None:
        eval = await async_client.org.agents.evals.delete(
            eval_id=0,
            org_id="org_id",
        )
        assert eval is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.agents.evals.with_raw_response.delete(
            eval_id=0,
            org_id="org_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.agents.evals.with_streaming_response.delete(
            eval_id=0,
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.agents.evals.with_raw_response.delete(
                eval_id=0,
                org_id="",
            )
