...
class TestFaqs:
    ...
    def test_method_create(self, client: Cozmoai) -> None:
        faq = client.org.faqs.create(
            org_id="org_id",
            answer="x",
            question="x",
        )
        assert_matches_type(Faq, faq, path=["response"])
    ...
    def test_raw_response_create(self, client: Cozmoai) -> None:
        response = client.org.faqs.with_raw_response.create(
            org_id="org_id",
            answer="x",
            question="x",
        )
    ...
    def test_streaming_response_create(self, client: Cozmoai) -> None:
        with client.org.faqs.with_streaming_response.create(
            org_id="org_id",
            answer="x",
            question="x",
        ) as response:
    ...
    def test_path_params_create(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.faqs.with_raw_response.create(
                org_id="",
                answer="x",
                question="x",
            )
    ...
    def test_raw_response_retrieve(self, client: Cozmoai) -> None:
        response = client.org.faqs.with_raw_response.retrieve(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Cozmoai) -> None:
        with client.org.faqs.with_streaming_response.retrieve(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.faqs.with_raw_response.retrieve(
                faq_id="faq_id",
                org_id="",
            )

        with pytest.raises(ValueError, match=r"Expected a non-empty value for `faq_id` but received ''"):
            client.org.faqs.with_raw_response.retrieve(
                faq_id="",
                org_id="org_id",
            )
    ...
    def test_raw_response_update(self, client: Cozmoai) -> None:
        response = client.org.faqs.with_raw_response.update(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_update(self, client: Cozmoai) -> None:
        with client.org.faqs.with_streaming_response.update(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_update(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.faqs.with_raw_response.update(
                faq_id="faq_id",
                org_id="",
            )
    ...
    def test_method_list(self, client: Cozmoai) -> None:
        faq = client.org.faqs.list(
            org_id="org_id",
        )
        assert_matches_type(FaqListResponse, faq, path=["response"])
    ...
    def test_raw_response_list(self, client: Cozmoai) -> None:
        response = client.org.faqs.with_raw_response.list(
            org_id="org_id",
        )
    ...
    def test_streaming_response_list(self, client: Cozmoai) -> None:
        with client.org.faqs.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.faqs.with_raw_response.list(
                org_id="",
            )
    ...
    def test_raw_response_delete(self, client: Cozmoai) -> None:
        response = client.org.faqs.with_raw_response.delete(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_delete(self, client: Cozmoai) -> None:
        with client.org.faqs.with_streaming_response.delete(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_delete(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.faqs.with_raw_response.delete(
                faq_id="faq_id",
                org_id="",
            )
...
class TestAsyncFaqs:
    ...
    async def test_method_create(self, async_client: AsyncCozmoai) -> None:
        faq = await async_client.org.faqs.create(
            org_id="org_id",
            answer="x",
            question="x",
        )
    ...
    async def test_raw_response_create(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.faqs.with_raw_response.create(
            org_id="org_id",
            answer="x",
            question="x",
        )
        ...
        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        faq = await response.parse()
        assert_matches_type(Faq, faq, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_create(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.faqs.with_streaming_response.create(
            org_id="org_id",
            answer="x",
            question="x",
        ) as response:
    ...
    async def test_path_params_create(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.faqs.with_raw_response.create(
                org_id="",
                answer="x",
                question="x",
            )
    ...
    async def test_method_retrieve(self, async_client: AsyncCozmoai) -> None:
        faq = await async_client.org.faqs.retrieve(
            faq_id="faq_id",
            org_id="org_id",
        )
        assert_matches_type(Faq, faq, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.faqs.with_raw_response.retrieve(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.faqs.with_streaming_response.retrieve(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.faqs.with_raw_response.retrieve(
                faq_id="faq_id",
                org_id="",
            )
    ...
    async def test_method_update(self, async_client: AsyncCozmoai) -> None:
        faq = await async_client.org.faqs.update(
            faq_id="faq_id",
            org_id="org_id",
        )
        assert_matches_type(Faq, faq, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.faqs.with_raw_response.update(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.faqs.with_streaming_response.update(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_update(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.faqs.with_raw_response.update(
                faq_id="faq_id",
                org_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCozmoai) -> None:
        faq = await async_client.org.faqs.list(
            org_id="org_id",
        )
        assert_matches_type(FaqListResponse, faq, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.faqs.with_raw_response.list(
            org_id="org_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.faqs.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.faqs.with_raw_response.list(
                org_id="",
            )
    ...
    async def test_method_delete(self, async_client: AsyncCozmoai) -> None:
        faq = await async_client.org.faqs.delete(
            faq_id="faq_id",
            org_id="org_id",
        )
        assert faq is None
    ...
    async def test_raw_response_delete(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.faqs.with_raw_response.delete(
            faq_id="faq_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_delete(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.faqs.with_streaming_response.delete(
            faq_id="faq_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_delete(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.faqs.with_raw_response.delete(
                faq_id="faq_id",
                org_id="",
            )
