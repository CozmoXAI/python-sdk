...
from cozmoai.types.org import RunResponse, PaginatedRunsExtendedResponse
...
class TestRuns:
    ...
    def test_method_retrieve(self, client: Cozmoai) -> None:
        run = client.org.runs.retrieve(
            run_id="run_id",
            org_id="org_id",
        )
        assert_matches_type(RunResponse, run, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: Cozmoai) -> None:
        response = client.org.runs.with_raw_response.retrieve(
            run_id="run_id",
            org_id="org_id",
        )
    ...
    def test_streaming_response_retrieve(self, client: Cozmoai) -> None:
        with client.org.runs.with_streaming_response.retrieve(
            run_id="run_id",
            org_id="org_id",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.runs.with_raw_response.retrieve(
                run_id="run_id",
                org_id="",
            )
    ...
    def test_method_list(self, client: Cozmoai) -> None:
        run = client.org.runs.list(
            org_id="org_id",
        )
        assert_matches_type(PaginatedRunsExtendedResponse, run, path=["response"])
    ...
    def test_raw_response_list(self, client: Cozmoai) -> None:
        response = client.org.runs.with_raw_response.list(
            org_id="org_id",
        )
    ...
    def test_streaming_response_list(self, client: Cozmoai) -> None:
        with client.org.runs.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    def test_path_params_list(self, client: Cozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            client.org.runs.with_raw_response.list(
                org_id="",
            )
...
class TestAsyncRuns:
    ...
    async def test_method_retrieve(self, async_client: AsyncCozmoai) -> None:
        run = await async_client.org.runs.retrieve(
            run_id="run_id",
            org_id="org_id",
        )
        assert_matches_type(RunResponse, run, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.runs.with_raw_response.retrieve(
            run_id="run_id",
            org_id="org_id",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.runs.with_streaming_response.retrieve(
            run_id="run_id",
            org_id="org_id",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.runs.with_raw_response.retrieve(
                run_id="run_id",
                org_id="",
            )
    ...
    async def test_method_list(self, async_client: AsyncCozmoai) -> None:
        run = await async_client.org.runs.list(
            org_id="org_id",
        )
        assert_matches_type(PaginatedRunsExtendedResponse, run, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncCozmoai) -> None:
        response = await async_client.org.runs.with_raw_response.list(
            org_id="org_id",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncCozmoai) -> None:
        async with async_client.org.runs.with_streaming_response.list(
            org_id="org_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncCozmoai) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `org_id` but received ''"):
            await async_client.org.runs.with_raw_response.list(
                org_id="",
            )
